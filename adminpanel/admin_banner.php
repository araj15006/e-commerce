...
$getQuery = "SELECT * FROM banner " . $where . "  order by $field $mode LIMIT " . $initial_page . ',' . $limit;
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">User List <a href="admin_banner_listing.php">
                            ...
                            while ($data = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="http://localhost/ecommerce/img/<?= $data['image_name']; ?>" height="100px" alt="">
                                    ...
                                    <td>
                                        <a href="admin_banner_update.php?id=<?= $data['id'] ?>"><button type="button" 
                                                class="btn  btn-success btn-xs">update</button></a>
                                        <a href="admin_banner_del.php?id=<?php echo $data['id']; ?>"> <button type="button"
                                                class="btn  btn-secondary btn-xs">delete</button></a>
                                    </td>
                                    <td>
                                       
                                        <? if ($data['status'] == 1) { ?>
                                            <a href="admin_banner_status.php?id=<?php echo $data['id']; ?>"><button type="button"
                    ...
                    <div class="action" style="text-align: center;">
                        ...
                        for ($page_number1 = 1; $page_number1 <= $total_pages; $page_number1++) {
                            ...
                            if ($page_number == $page_number1) {
                                echo '<a class="action" href = "admin_banner.php?feild=' . $field . '&mode=' . $mode . '&page=' . $page_number1 . '">' . $page_number1 . ' </a>';
                            } else {
                                echo '<a  href = "admin_banner.php?feild=' . $field . '&mode=' . $mode . '&page=' . $page_number1 . '">' . $page_number1 . ' </a>';
                            }
                        } ?>
