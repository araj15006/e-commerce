...
if(isset($_POST['title'])){
    while ($banner_featch = mysqli_fetch_assoc($banner_query_run)) {
     ...
     if($i <= 8 ){
      ...
      $image_upload_query = "INSERT INTO `banner`(`image_name`,`title`, `disc`, `status`) VALUES ('$file_name','$title','$disc','1')";
  ...
  <?= $sucess ?>
        ...
        <form accept-charset="UTF-8" action="" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <br>
            <input type="text" name="disc" class="form-control"  placeholder="About this banner">
          </div>
          <hr>
