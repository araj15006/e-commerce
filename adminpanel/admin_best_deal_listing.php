...
$sucess = "";
$i = 1;
$banner_query = "select * from special_offer_down  where `status`='1'";
...
if(isset($_POST['title'])){
    while ($banner_featch = mysqli_fetch_assoc($banner_query_run)) {
     ...
     if($i <= 8 ){
      ...
      $image_upload_query = "INSERT INTO `special_offer_down`(`image_name`,`title`, `offer_percentage`) VALUES ('$file_name','$title','$disc')";
