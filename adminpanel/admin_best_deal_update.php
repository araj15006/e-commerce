...
if(isset($_POST['title'])){    
      ...
      $image_upload_query = "UPDATE `special_offer_down` SET `title`='$title', `offer_percentage` ='$disc',`image_name`='$file_name' WHERE `id` = $id ";
    ...
    <?  }?>
        ...
        <form accept-charset="UTF-8" action="" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <br>
            <input type="text" name="disc" class="form-control"  placeholder="write about this offer">
          </div>
          <hr>
          ...
          <a href="admin_best_deal.php"> <button style="margin-left:77%" type="button" class="btn btn-default">Home</button></a>
        </form>
    </div> 
</div>
<?
