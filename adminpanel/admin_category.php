...
$getQuery = "SELECT * FROM category " . $where . "  order by $field $mode LIMIT " . $initial_page . ',' . $limit;
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">User List <a href="admin_category_listing.php">
                            ...
                            while ($data = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="admin_category_update.php?id=<?php echo $data['id']; ?>"><button
                                                type="button" class="btn  btn-success btn-xs">update</button></a>
                                        <a href="admin_category_del.php?id=<?php echo $data['id']; ?>"> <button
                                                type="button" class="btn  btn-secondary btn-xs">delete</button></a>
                                    </td>
                                    <td>

                                        <? if ($data['status'] == 1) { ?>
                                            <a href="admin_category_status.php?id=<?php echo $data['id']; ?>"><button
