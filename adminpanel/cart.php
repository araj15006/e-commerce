...
$getQuery = "SELECT * FROM cart " . $where . "  order by $field $mode LIMIT " . $initial_page . ',' . $limit;
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                <th>SEARILS</th>
                                <th><a href="banner.php?field=id&mode=<?php echo $mode; ?>">Id</a></th>
                                <th>user id</th>
                                <th>SHIPPING ADDRESS</th>
                                <th>SHIPPING CITY</th>
                                <th>SHIPPING STATE_ID</th>
                                <th>GROSS AMOUNT</th>
                                <th>NET AMOUNT</th>
                                <th>COUPONS ID</th>
                                <th>SHIPPING CHARGE_ID</th>
                                <th>DISCOUNT AMOUN</th>
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $data['shipping_city']; ?>
                                    </td>
                                    <td>
                                        <?php echo $data['shipping_state_id']; ?>
                                    </td>
                                    <td>
                                        <?php echo $data['shipping_country_id']; ?>
                                    </td>
                                    <td>
                                        <?php echo $data['gross_amount']; ?>
                                    </td>
                                    <td>
                                        <?php echo $data['net_amount']; ?>
                                    </td>
                                    <td>
                                        <?php echo $data['coupon_id']; ?>
                                    </td>
                                    <td>
                                        <?php echo $data['shipping_charge_id']; ?>
                                    </td>
                                    <td>
